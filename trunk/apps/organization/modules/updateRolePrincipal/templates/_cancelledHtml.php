...
<br>
<br>
<?php echo __("A manager of organization <strong>%organization%</strong> has cancelled your membership of role <strong>%role%</strong>.", array("%organization%"=>$o, "%role%"=>$r->getName())); ?>
<br>
<br>
<br>
<br>

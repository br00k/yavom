...
/**
 * RoleEntitlementPack form base class.
 *
 * @method RoleEntitlementPack getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseRoleEntitlementPackForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('role_entitlement_pack[%s]');
